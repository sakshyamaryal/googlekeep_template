<template>
  <div class="form-container active-form">
    <form id="todo-box">
      <div class="contents-icon">
        <br>
        <input type="text" class="form-control border-0 shadow-none" placeholder="Title" />
        <div>
          <svg
            class="thumbtack"
            style="height: 20px"
  ...
  <fieldset class="form-container-notes">
    ...
    <span class="check-circle">
      <svg style="height: 15px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
        <path
