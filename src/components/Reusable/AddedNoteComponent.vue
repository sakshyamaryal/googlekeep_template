<template>
  <!-- <draggable class="draggable-note" :list="note" group="note"> -->
    <!-- <template #item="{ element }"> -->
    <fieldset class="form-container-notes" @click="editNote">
      <div class="check-thumbtack">
        <!-- <svg class="svg-content"  style="height: 15px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.<path d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"/></svg> -->

        <svg
          class="thumbtack svg-content"
          style="height: 14px"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 384 512"
        >
          <path
            class="thumbtack-path"
      ...
      <span class="check-circle">
        ...
        >
          <path
            class="thumbtack-circle"
            d="M438.6 105.4c12.5 12.5 12.5 32.8 0 45.3l-256 256c-12.5 12.5-32.8 12.5-45.3 0l-128-128c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0L160 338.7 393.4 105.4c12.5-12.5 32.8-12.5 45.3 0z"
          />
        </svg>
      </span>
      <div class="title" style="word-wrap: break-word; font-weight: bold">{{ note.title }}</div>
      <br />
...
.form-container-notes:hover .svg-content,
.form-container-notes:hover .check-circle {
  visibility: visible;
  opacity: 1;
}
...
.form-container-notes:hover {
  /*   
  box-shadow: 0 0 11px rgba(153, 40, 40, 0.2);  */
