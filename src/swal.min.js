  ...
  var n = {
    ...
    x = function (n) {
      ...
      ;(t = e && s && e.parentNode !== s.parentNode ? A(n) : e || A(n)),
        ...
        n.padding &&
          (t.style.padding = 'number' == typeof n.padding ? n.padding + 'px' : n.padding),
    ...
    v = function n() {
      ...
      if ('undefined' != typeof window) {
        ...
        switch (w(e[0])) {
          ...
          default:
            return (
              i('Unexpected type of argument! Expected "string" or "object", got ' + w(e[0])), !1
            )
        }
        x(s)
        var c = E(),
          ...
          if (
            ...
            ;(m.onmousedown = function () {
              ...
              (c.onclick = function (t) {
                A
                  ? (A = !1)
                  : t.target === c && p(s.allowOutsideClick) && r(n.DismissReason.backdrop)
              })
          }
          var B = j(),
            L = Z(),
